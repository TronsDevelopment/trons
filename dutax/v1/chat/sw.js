...
// 🧩 UTILITIES
// ============================
const log = (...a) => console.log('[DutaX SW]', ...a);
const warn = (...a) => console.warn('[DutaX SW]', ...a);
...
self.addEventListener('push', event => {
  ...
  const title = data.title || 'DutaX Update';
  const body = data.body || 'Ada pembaruan baru di DutaX!';
